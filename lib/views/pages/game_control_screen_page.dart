...
class GameControlScreenPage extends StatefulWidget {
  const GameControlScreenPage(
      {super.key, required this.game, required this.monitor});
  ...
  void _initWebViewController() {
    _webViewController = WebViewController()
      ...
      ..loadRequest(Uri.parse(
          'http://${widget.monitor.getIp}:2227/game/controller.html'));
  }
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            onPressed: () {
              ...
              _monitorController.closeGame(widget.game, widget.monitor);
            },
            icon: Icon(
              Icons.arrow_back,
            )),

...
class _MainProfilePageState extends State<MainProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_residence != null) print(_residence?.toObject());
    return Container(
      child: Column(
        children: [
          Stack(
            ...
            children: [
              Positioned(
                child: Container(
                  height: 140,
                  decoration: BoxDecoration(color: ColorUtils.primary),
                ),
              ),
              Positioned(
                top: 20,
                ...
                child: Container(
                  ...
                  child: Center(
                    child: CircleAvatar(
                      ...
                      radius: 65,
                      foregroundImage: _profile?.userProfileImageFile != null
                          ? FileImage(_profile!.userProfileImageFile)
                          : null,
                    ),
                  ),
                ),
          ...
          UserDetailsBloc(profile: _profile, residence: _residence,),
